...
export function Navbar() {
    return (
        <div className="py-4 border-b bg-black border-[#7C3AED]">
            <div className="container max-w-6xl mx-auto flex h-16 items-center justify-between">
                    ...
                    <NavigationMenuList className=" gap-6">
                        ...
                        <NavigationMenuItem>
                            <Link href="/Company" legacyBehavior passHref>
                                <NavigationMenuLink className={cn(navigationMenuTriggerStyle(), "bg-black text-lg text-white hover:bg-black hover:text-white")}>
                                    Company
                                </NavigationMenuLink>
                            </Link>
                        </NavigationMenuItem>
                ...
                <Button className="rounded-full bg-[#7C3AED] px-6 py-6 text-lg text-white hover:bg-[#7C3AED]/90">
                    Get This Template
                </Button>
            </div>
        </div>
        ...
        <li>
            <NavigationMenuLink asChild>
                ...
                >
                    ...
                    {subtitle && <p className="line-clamp-2 text-sm leading-snug text-gray-400">{subtitle}</p>}
                </a>
            </NavigationMenuLink>
        </li>
    )
